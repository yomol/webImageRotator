...
@Component({
  selector: 'app-white-component-clinic',
  templateUrl: './white-component-clinic.component.html',
  styleUrls: ['./white-component-clinic.component.css']
})
export class WhiteComponentClinicComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.viewerApi.licenseCode = 'https://webrotatorstorage.blob.core.windows.net/webrotator/public/license.lic';
    this.viewerApi.settings.configFileURL = 'https://webrotatorstorage.blob.core.windows.net/webrotator/white%20Background/published/360_assets/white%20Background/white%20Background.xml';
    this.viewerApi.settings.graphicsPath = 'https://webrotatorstorage.blob.core.windows.net/webrotator/white%20Background/published/imagerotator/html/img/basic';
